 ...
 */
$config ['ldap_uri'] = array('ldap://nsv22.novacap.sede/');
$config['use_tls'] = false; // Encrypted without using SSL
$config['search_base'] = 'DC=NOVACAP,DC=SEDE';
$config['user_object_class'] = 'user';
$config['group_object_class'] = 'group';
$config['user_search_filter'] = 'sAMAccountName=';  // Additional search filters to use for user lookups
$config['group_search_filter'] = 'memberof'; // Additional search filters to use for group lookups
$config['login_attribute'] = 'sAMAccountName';
$config['schema_type'] = 'rfc2307bis'; // Use rfc2307, rfc2307bis, or ad
$config['roles'] = array(1 => 'SGPOAdmin', 
                         3 => 'SGPOUser');
